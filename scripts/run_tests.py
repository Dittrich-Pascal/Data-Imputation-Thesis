...
for i in REGRESSION_TASK_IDS:
    for j in methods:
        os.system(f"python run-experiment-subset.py {i} {j} corrupted_regression_experiment --missing-fractions 0.01,0.1,0.3,0.5 --missing-types MCAR,MAR,MNAR --strategies single_single --num-repetitions 3 --base-path ../results")
...
for i in BINARY_TASK_IDS:
    for j in methods:
        os.system(f"python run-experiment-subset.py {i} {j} corrupted_binary_experiment_subset --missing-fractions 0.01,0.1,0.3,0.5 --missing-types MCAR,MAR,MNAR --strategies single_single --num-repetitions 3 --base-path ../results")
...
for i in MULTI_TASK_IDS:
    for j in methods:
        os.system(f"python run-experiment-subset.py {i} {j} corrupted_multi_experiment_subset --missing-fractions 0.01,0.1,0.3,0.5 --missing-types MCAR,MAR,MNAR --strategies single_single --num-repetitions 3 --base-path ../results")
...
for i in BINARY_TASK_IDS:
    for j in methods:
        os.system(f"python run-experiment.py {i} {j} baseline_binary_experiment --missing-fractions 0.01,0.1,0.3,0.5 --missing-types MCAR,MAR,MNAR --strategies single_single --num-repetitions 3 --base-path ../results")
...
for i in MULTI_TASK_IDS:
    for j in methods:
        os.system(f"python run-experiment.py {i} {j} baseline_multi_experiment --missing-fractions 0.01,0.1,0.3,0.5 --missing-types MCAR,MAR,MNAR --strategies single_single --num-repetitions 3 --base-path ../results")
...
for i in REGRESSION_TASK_IDS:
    for j in methods:
        os.system(f"python run-experiment.py {i} {j} baseline_regression_experiment --missing-fractions 0.01,0.1,0.3,0.5 --missing-types MCAR,MAR,MNAR --strategies single_single --num-repetitions 3 --base-path ../results")
