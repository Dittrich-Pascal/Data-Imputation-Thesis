...
class AutoKerasImputer(BaseImputer):
    ...
    def fit(self, data: pd.DataFrame, target_columns: List[str]) -> BaseImputer:
        ...
        with tf.device('/GPU:0'): # 42712 dl -> Trial:Time = 1:37s,2:32s,3:19s,4:44s
        #with tf.device('/CPU:0'): # 42712 dl -> Trial:Time = 1:16s,2:17s,3:12s,4:23s
            ...
            for target_column in self._target_columns:
                ...
                print("Training Starts here ___________________________________--")
